#include <string.h>
#include <stdio.h>
#include <lely/bsp/ring_buffer.h>
#include <lely/bsp/can.h>
#include <lely/util/util.h>
#include <lely/co/co.h>
#include <lely/util/diag.h>
#include <stm32g4xx.h>
//#include "../../Drivers/CMSIS/Device/ST/STM32G4xx/Include/stm32g4xx.h"
#include "main.h"
...
void can_init(int __unused bitrate)
{
...
//    tx_hdr.TxFrameType = (buffer->ident & FLAG_RTR) ? FDCAN_REMOTE_FRAME : FDCAN_DATA_FRAME
    ...
    offset += sprintf(data_str + offset, "  ID: 0x%4x", (unsigned int)msg.ID);
    offset += sprintf(data_str + offset, "  Length: %li", msg.DLC);
