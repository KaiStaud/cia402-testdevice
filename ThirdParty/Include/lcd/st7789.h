...
#define ST7789_DC_PORT  LCD_DCX_GPIO_Port
#define ST7789_DC_PIN   LCD_DCX_Pin
 ...
 * 4 parameters can be choosed
 * 135x240(0.96 inch) & 240x240(1.3inch) & 170x320(1.9inch) & 240x320(2.8inch)
